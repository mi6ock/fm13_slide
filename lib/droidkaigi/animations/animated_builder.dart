...
class _AnimatedBuilderExampleWidgetState
  ...
  void initState() {
    ...
    _colorAnimation =
        ColorTween(begin: Colors.white, end: flutterLightGreen).animate(
      CurvedAnimation(
        parent: _controller,
    ...
    _colorMediumAnimation =
        ColorTween(begin: Colors.white, end: flutterMediumGreen).animate(
      CurvedAnimation(
        parent: _controller,
        curve: Interval(0.25, 0.5),
      ),
    ...
    _colorDarkAnimation =
        ColorTween(begin: Colors.white, end: flutterDarkGreen).animate(
      CurvedAnimation(
        parent: _controller,
        curve: Interval(0.25, 0.5),
      ),
